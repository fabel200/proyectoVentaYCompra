...
public class VentaPDF {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            String nombre = "Bodegon La Peñita";
            String telefono = "04122666330";
            String direccion = "Sector La Peñita, 1era calle.";
            String razon = "gracias por su compra, vuelva pronto";
            ...
            for(int i = 0; i < InterVentas.jTable_carrito.getRowCount(); i++){
                String producto = InterVentas.jTable_carrito.getValueAt(i, 1).toString();
                String cantidad = InterVentas.jTable_carrito.getValueAt(i, 2).toString();
                String precio = InterVentas.jTable_carrito.getValueAt(i, 3).toString();
                String total = InterVentas.jTable_carrito.getValueAt(i, 7).toString();
