...
public class DetalleVenta {
   ...
   /* public DetalleVenta( int idProducto, String nombre, int cantidad, double precioUnitario, double subTotal, double descuento, double iva, double totalPagar) {
        this.idProducto = idProducto;
        this.nombre = nombre;
        this.cantidad = cantidad;
        this.precioUnitario = precioUnitario;
    ...
    public String toString() {
       ...
       private void calcularTotales() {
           ...
           this.totalPagar = this. subTotal + (this.subTotal * this.iva/100);
       }
